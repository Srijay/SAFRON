...
GLAND_MASK_THRESHOLD = 85

masks_folder = "F:/Datasets/CRAG_LabServer/SAFRON/c5/test/masks"
images_folder = "F:/Datasets/CRAG_LabServer/SAFRON/c5/test/images"
outfolder = "F:/Datasets/CRAG_LabServer/SAFRON/c5/test/trimasks"
...
def extract_image(mask_path):
    ...
    mask_np[mask_np < GLAND_MASK_THRESHOLD] = 0 #tissue + white portion
    mask_np[mask_np >= GLAND_MASK_THRESHOLD] = 2 #glands
